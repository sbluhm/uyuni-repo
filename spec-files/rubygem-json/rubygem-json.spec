...
ls %{gembuilddir}
ls %{gembuilddir}/extensions
ls %{gembuilddir}/extensions/x86_64-linux
mv %{gembuilddir}/extensions/x86_64-linux/*/%{rbname}-%{version}/*.so %{buildroot}%{_libdir}/gems/ruby/%{rbname}-%{version}
