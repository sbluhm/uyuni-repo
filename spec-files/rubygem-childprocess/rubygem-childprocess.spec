# Generated from childprocess-4.0.0.gem by gem2rpm -*- rpm-spec -*-
...
%defattr(-, root, root)
%{gemdir}/gems/childprocess-4.0.0/

%{gemdir}/cache/childprocess-4.0.0.gem
%{gemdir}/specifications/childprocess-4.0.0.gemspec
