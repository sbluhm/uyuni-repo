...
%doc README.rst
%license LICENSE
%{python2_sitelib}/typing.py*
%{python2_sitelib}/typing-%{version}-py*.egg-info/

%changelog
* Thu Jan 30 2020 Fedora Release Engineering <releng@fedoraproject.org> - 3.7.4.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_32_Mass_Rebuild

* Tue Oct 22 2019 Paul Howarth <paul@city-fan.org> - 3.7.4.1-1
- Update to 3.7.4.1 (#1347637)
