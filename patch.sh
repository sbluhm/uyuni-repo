...
# PR4623
curl https://raw.githubusercontent.com/sbluhm/uyuni/fix-4614/python/spacewalk/server/importlib/headerSource.py -o /usr/lib/python3.6/site-packages/spacewalk/server/importlib/headerSource.py
