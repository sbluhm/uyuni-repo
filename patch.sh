dnf -y install \
	...
	https://download.copr.fedorainfracloud.org/results/sbluhm/uyuni-server/epel-8-x86_64/01852572i-spacewalk-java/spacewalk-java-config-4.2.5-1.el8.noarch.rpm \
